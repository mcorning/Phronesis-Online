...
var Fo = {
  ...
  ri = class extends L.PluginSettingTab {
    ...
    add_donating_setting() {
      ...
      (i.setAttribute(
        'href',
        'https://www.paypal.com/support?hosted_button_id=U2SRGAFYXT32Q',
      ),
